...
function db_connect() { // function to connect your form to your database
    try {
        $dsn = "mysql:host=" . DB_SERVER . ";dbname=" . DB_NAME . ";charset=utf8mb4"; // Data Source Name type of db
        $options = [
...
// connection to mysql db handling errors, and ensuring queries are successful.
